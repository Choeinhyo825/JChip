...
public class B_NewSprintPopUp extends JPanel {
	...
	public B_NewSprintPopUp(MainFrame mainFrame, B_SprintPanel sprintPanel) {
		...
		/*
		 * if(sprintName.getText().equals("")) { sprintName.setText("새 스프린트 이름"); }
		 */
		 ...
		 * 
		 * @Override public void mouseClicked(MouseEvent e) { if(startDayCtn == 0) {
		 ...
		 * 
		 * @Override public void keyPressed(KeyEvent e) { startDayCtn++; } });
		 */
		 ...
		 * 
		 * @Override public void mouseClicked(MouseEvent e) { if(endDayCtn == 0) {
		 ...
		 * 
		 * @Override public void keyPressed(KeyEvent e) { endDayCtn++; } });
		 */
		 ...
		 * JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED); scrollBar.setPreferredSize(new
		 * Dimension(453, 135)); scrollBar.setLocation(20, 175);
		 */
